    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "18px", lineHeight: "1.6" }}>
          ...
          mood and genre. As a passionate developer, I, Shivam Upadhyay, created
          a platform that goes beyond playlists to offer mood and genre-specific
          YouTube playlists.
        </p>
        <p style={{ fontSize: "18px", lineHeight: "1.6" }}>
        ...
        <p style={{ fontSize: "18px", lineHeight: "1.6" }}>
          At Mood Songs, our mission is to make music discovery easier and more
          personal. With just one click, anyone can access a playlist that fits
          their mood. We cover over 20 moods and 10 languages, ensuring there is
          always a song that matches your emotional state.
        </p>
        <ul style={{ fontSize: "18px", marginLeft: "20px" }}>
          <li>
            <strong>Purpose:</strong> Provide an intuitive platform for mood and
        ...
        <ul style={{ fontSize: "18px", marginLeft: "20px" }}>
          <li>
            <strong>Unique:</strong> Every song and playlist is handpicked with
            research in all 10 languages.
          </li>
          <li>
        ...
        <p style={{ fontSize: "18px", lineHeight: "1.6" }}>
          MoodSongs has resonated with music enthusiasts across the internet.
        ...
        >
          “MoodSongs is my daily go-to for finding songs that lift me up or calm
          me down. It’s like having a musical friend who gets me.” – Sarah L.
        </blockquote>
        <blockquote
          style={{
            fontSize: "20px",
